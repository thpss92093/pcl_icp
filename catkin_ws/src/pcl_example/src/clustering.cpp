...
// void callback_rosbag(const sensor_msgs::ImageConstPtr& color_image_1, const sensor_msgs::ImageConstPtr& depth_image_1, const sensor_msgs::CameraInfoConstPtr& cam_info_1, \
                  const sensor_msgs::ImageConstPtr& color_image_2, const sensor_msgs::ImageConstPtr& depth_image_2, const sensor_msgs::CameraInfoConstPtr& cam_info_2)
void callback_rosbag(const sensor_msgs::ImageConstPtr& color_image_1, const sensor_msgs::ImageConstPtr& depth_image_1, const sensor_msgs::CameraInfoConstPtr& cam_info_1)
{
...
int main (int argc, char** argv)
{
  ...
  // cloud_publisher_2 = nh.advertise<sensor_msgs::PointCloud2> ("/zedm02/zed/zed_node/pointcloud", 1);
  cloud_filted_publisher_1 = nh.advertise<sensor_msgs::PointCloud2> ("/zedm01/zed/zed_node/pointcloud_filted", 1);
  // cloud_filted_publisher_2 = nh.advertise<sensor_msgs::PointCloud2> ("/zedm02/zed/zed_node/pointcloud_filted", 1);


  bool rosbag_flag = true;
  // nh.getParam("rosbag", rosbag_flag);
  
  /*if(rosbag_flag){
    cout << "in rosbag_flag" <<endl;
    ...
    // message_filters::Subscriber<sensor_msgs::Image> color_image_sub_2(nh, "/zedm02/zed/zed_node/rgb/image_rect_color", 1);
    // message_filters::Subscriber<sensor_msgs::Image> depth_image_sub_2(nh, "/zedm02/zed/zed_node/depth/depth_registered", 1);
    // message_filters::Subscriber<sensor_msgs::CameraInfo> info_sub_2(nh, "/zedm02/zed/zed_node/rgb/camera_info", 1);
    // typedef message_filters::sync_policies::ExactTime<sensor_msgs::Image, sensor_msgs::Image, sensor_msgs::CameraInfo, \
    //                                                   sensor_msgs::Image, sensor_msgs::Image, sensor_msgs::CameraInfo> MySyncPolicy;
    // message_filters::Synchronizer<MySyncPolicy> sync(MySyncPolicy(10), color_image_sub_1, depth_image_sub_1, info_sub_1, \
    //                                                                     color_image_sub_2, depth_image_sub_2, info_sub_2);
    // sync.registerCallback(boost::bind(&callback_rosbag, _1, _2, _3, _4, _5, _6));
    ...
    cout << "end rosbag_flag" <<endl;
  }
  else{
    message_filters::Subscriber<sensor_msgs::PointCloud2> pc_sub_1(nh, "/zedm01/zed/zed_node/point_cloud/cloud_registered", 1);
    message_filters::Subscriber<sensor_msgs::PointCloud2> pc_sub_2(nh, "/zedm02/zed/zed_node/point_cloud/cloud_registered", 1);
    typedef message_filters::sync_policies::ExactTime<sensor_msgs::PointCloud2, sensor_msgs::PointCloud2> MySyncPolicy;
    message_filters::Synchronizer<MySyncPolicy> sync(MySyncPolicy(10), pc_sub_1, pc_sub_2);
    sync.registerCallback(boost::bind(&callback_realtime, _1, _2));
  }*/
  message_filters::Subscriber<sensor_msgs::Image> color_image_sub_1(nh, "/zedm01/zed/zed_node/rgb/image_rect_color", 1);
  message_filters::Subscriber<sensor_msgs::Image> depth_image_sub_1(nh, "/zedm01/zed/zed_node/depth/depth_registered", 1);
  message_filters::Subscriber<sensor_msgs::CameraInfo> info_sub_1(nh, "/zedm01/zed/zed_node/rgb/camera_info", 1);
